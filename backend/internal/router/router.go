...
func Setup() *gin.Engine {
	...
	api := r.Group("/api")
	{
		...
		api.POST("/sync/notes/:id", handler.SyncNote)
		api.POST("/sync/targets/:target_id/push", handler.SyncTargetPush)
		api.POST("/sync/targets/:target_id/pull", handler.SyncTargetPull)
		api.POST("/sync/targets/:target_id/bidirectional", handler.SyncTargetBidirectional)
		api.GET("/sync/targets/:target_id/deletions", handler.ListTargetDeletions)
		api.POST("/sync/targets/:target_id/deletions/:note_id/confirm", handler.ConfirmTargetDeletion)
		api.POST("/sync/targets/:target_id/deletions/:note_id/restore", handler.RestoreTargetDeletion)
