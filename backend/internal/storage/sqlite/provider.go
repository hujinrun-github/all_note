...
func (s *store) Folders() storage.FolderRepository {
	panic("sqlite folder repository is not implemented yet")
}

func (s *store) Notes() storage.NoteRepository {
	panic("sqlite note repository is not implemented yet")
}
...
func (s *store) Search() storage.SearchRepository {
	panic("sqlite search repository is not implemented yet")
}
