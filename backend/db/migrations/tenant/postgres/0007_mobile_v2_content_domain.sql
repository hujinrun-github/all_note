ALTER TABLE notes ADD COLUMN IF NOT EXISTS client_id TEXT;
...
ALTER TABLE notes ADD COLUMN IF NOT EXISTS revision BIGINT NOT NULL DEFAULT 1;
...
BEGIN
  IF EXISTS (
    ...
    EXECUTE 'UPDATE notes SET body = content_text WHERE body = '''' AND content_text <> ''''';
  END IF;
END
$$;
...
CREATE TABLE IF NOT EXISTS voice_notes (
  ...
  revision BIGINT NOT NULL DEFAULT 1 CHECK (revision > 0),
  deleted_at TIMESTAMPTZ,
  audio_revision BIGINT NOT NULL DEFAULT 1 CHECK (audio_revision > 0),
