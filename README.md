...
```bash
FLOWSPACE_DATABASE_URL="postgres://postgres:12345@192.168.1.13:19588/flowspace_test?sslmode=disable" make dev
```

**示例 — 正式库：**

```bash
FLOWSPACE_DATABASE_URL="postgres://postgres:12345@192.168.1.13:19588/flowspace?sslmode=disable" make dev-prod
```

> **项目默认 PostgreSQL 地址**：`192.168.1.13:19588`，用户 `postgres`，密码 `12345`。
...
FLOWSPACE_DATABASE_URL="postgres://postgres:12345@192.168.1.13:19588/flowspace?sslmode=disable" \
...
# 测试库
FLOWSPACE_ENV=test \
FLOWSPACE_DATABASE_URL="postgres://postgres:12345@192.168.1.13:19588/flowspace_test?sslmode=disable" \
go run ./cmd/server
...
$env:FLOWSPACE_DATABASE_URL = "postgres://postgres:12345@192.168.1.13:19588/flowspace_test?sslmode=disable"
go run ./cmd/server
```
